...
const UpdateBlog = () => {
  ...
  const handleUpdate = async (e: any) => {
    ...
    try {
      const res = await axios.put(`${apiUrl}/api/blog/update-blog/${id}`, {
        title: input.title,
  ...
  useEffect(() => {
    const fetchSingleBlog = async () => {
      const res = await axios.get(`${apiUrl}/api/blog/get-blog/${id}`);
      if (res.data) {
        setInput(res.data.blog);
      }
    };
    fetchSingleBlog();
  }, []);
